...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonInput, IonButton, IonList, IonLabel, IonItem, IonSelect, IonSelectOption } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonList, IonLabel, IonItem, IonButton, IonInput, IonContent, IonHeader, IonTitle, IonToolbar, IonSelect,
